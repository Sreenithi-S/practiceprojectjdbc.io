...
/**
 * Servlet implementation class ShowMoviesListCusomer
 */
@WebServlet("/ShowMoviesListCusomer")
public class ShowMoviesListCusomer extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ShowMoviesListCusomer() {
		super();
