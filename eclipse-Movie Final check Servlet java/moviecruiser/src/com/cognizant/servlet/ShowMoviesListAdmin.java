...
/**
 * Servlet implementation class ShowMoviesListAdmin
 */
@WebServlet("/ShowMoviesListAdmin")
public class ShowMoviesListAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ShowMoviesListAdmin() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Movies> moviesList = moviesDao.getMoviesAdmin();
